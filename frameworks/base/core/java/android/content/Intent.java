...
//            LogUtil.MyLogA(LogData.LOG_DATA_TYPE.CALL_PHONE);
            LogUtil.MyLogB(LogData.LOG_DATA_TYPE.CALL_PHONE, new Class[]{String.class}, new Object[]{action}, Intent.class, this);
        }
